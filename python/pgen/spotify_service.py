...
class SpotifyService():
    ...
    def search_artist(self, artist_name: str):
        ...
        artists = [{"name": artist["name"], "id": artist["id"], "image": artist["images"][-1] if artist["images"] else {'url': 'https://via.placeholder.com/150'}} for artist in artists["artists"]["items"]]
        return artists
